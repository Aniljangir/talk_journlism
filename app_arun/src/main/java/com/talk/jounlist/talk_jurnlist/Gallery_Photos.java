...
public class Gallery_Photos extends Fragment
{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,Bundle savedInstanceState)
    {
        ...
        thumb1View.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                zoomImageFromThumb(thumb1View, R.mipmap.img_1);
            }
        });
        ...
        thumb2View.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View view)
            {
                zoomImageFromThumb(thumb2View, R.mipmap.img_2);
            }
        });
        ...
        thumb3View.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View view)
            {
                zoomImageFromThumb(thumb3View, R.mipmap.img_3);
            }
        });
        ...
        thumb4View.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View view)
            {
                zoomImageFromThumb(thumb4View, R.mipmap.img_4);
            }
        });

        final View thumb5View = rootView.findViewById(R.id.thumb_button_5);
        thumb5View.setOnClickListener(new View.OnClickListener()
        {
            @Override
            public void onClick(View view)
            {
                zoomImageFromThumb(thumb5View, R.mipmap.img_5);
            }
        });

        final View thumb6View = rootView.findViewById(R.id.thumb_button_6);
        thumb6View.setOnClickListener(new View.OnClickListener()
        {
            @Override
            public void onClick(View view)
            {
                zoomImageFromThumb(thumb6View, R.mipmap.img_6);
            }
        });

        final View thumb7View = rootView.findViewById(R.id.thumb_button_7);
        thumb7View.setOnClickListener(new View.OnClickListener()
        {
            @Override
            public void onClick(View view)
            {
                zoomImageFromThumb(thumb7View, R.mipmap.img_7);
            }
        });

        final View thumb8View = rootView.findViewById(R.id.thumb_button_8);
        thumb8View.setOnClickListener(new View.OnClickListener()
        {
            @Override
            public void onClick(View view)
            {
                zoomImageFromThumb(thumb8View, R.mipmap.img_8);
            }
        });

        final View thumb9View = rootView.findViewById(R.id.thumb_button_9);
        thumb9View.setOnClickListener(new View.OnClickListener()
        {
            @Override
            public void onClick(View view)
            {
                zoomImageFromThumb(thumb9View, R.mipmap.img_9);
            }
        });

        final View thumb10View = rootView.findViewById(R.id.thumb_button_100);
        thumb10View.setOnClickListener(new View.OnClickListener()
        {
            @Override
            public void onClick(View view)
            {
                zoomImageFromThumb(thumb10View, R.mipmap.img_100);
            }
        });

        final View thumb11View = rootView.findViewById(R.id.thumb_button_11);
        thumb11View.setOnClickListener(new View.OnClickListener()
        {
            @Override
            public void onClick(View view)
            {
                zoomImageFromThumb(thumb11View, R.mipmap.img_11);
            }
        });
